...
if (isset($_POST["submit"])) {
    ...
    $link = $_POST["link"];
     ...
     $ad_id = $_POST['id']; // Get ad ID from form
        ...
        $sql_update = "UPDATE attack SET link='$link' WHERE id='$ad_id'";
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM attack WHERE id = $ad_id";
    ...
    <div class="login-box">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="input-box">
                ...
                <input type="text" name="link" value="<?php echo htmlspecialchars($link); ?>" readonly>
            ...
            <div class="input-box">
                ...
                <input type="link" name="link" value="<?php echo htmlspecialchars($link); ?>" required>
                <label>link</label>
                <div class="input-line"></div>
            </div>
...
if (isset($_POST["submit"])) {
    ...
    $link = $_POST["link"];
$adsid = $ad_id;
        $sql_update = "UPDATE attack SET link='$link' WHERE id='$adsid'";
        if (mysqli_query($conn, $sql)) {
            // Redirect to a page after successful insertion
            header("Location: /access/admin_file/index.php");
            exit(); // Terminate script after redirection
        } else {
